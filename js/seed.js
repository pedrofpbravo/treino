...
// entries: [exerciseSlug, targetSets, repMin, repMax] in card order.
    ...
    days: [
      {
        slug: "push", name: "Push",
        entries: [
          ["supino_maquina", 3, 6, 10],
          ["supino_inclinado_halteres", 3, 8, 12],
          ["crucifixo_maquina", 2, 10, 15],
          ["desenvolvimento_ombros_maquina", 2, 8, 12],
          ["elevacao_lateral_unilateral_polia", 3, 12, 20],
          ["triceps_pushdown", 2, 8, 12],
          ["triceps_frances_unilateral_halter", 2, 10, 15],
        ],
      },
      {
        slug: "pull", name: "Pull",
        entries: [
          ["puxada_alta_maquina", 3, 6, 10],
          ["remada_fechada_unilateral_maquina", 3, 8, 12],
          ["remada_alta_articulada_maquina", 2, 8, 12],
          ["face_pull", 2, 12, 20],
          ["biceps_maquina", 2, 8, 12],
          ["biceps_scott_unilateral_halter", 2, 10, 15],
        ],
      },
      {
        slug: "legs", name: "Legs",
        entries: [
          ["agachamento_pendulo", 3, 6, 10],
          ["leg_press_45", 2, 10, 15],
          ["cadeira_extensora", 2, 10, 15],
          ["cadeira_flexora_unilateral", 3, 10, 15],
          ["panturrilha_smith", 3, 8, 15],
          ["abdominal_maquina", 2, 10, 15],
        ],
      },
      {
        slug: "upper", name: "Upper",
        entries: [
          ["supino_maquina", 2, 8, 12],
          ["supino_inclinado_halteres", 2, 8, 12],
          ["puxada_alta_maquina", 2, 8, 12],
          ["remada_alta_articulada_maquina", 2, 8, 12],
          ["elevacao_lateral_unilateral_polia", 2, 12, 20],
          ["triceps_testa_polia", 2, 10, 15],
          ["biceps_scott_unilateral_halter", 2, 10, 15],
        ],
      },
      {
        ...
        entries: [
          ...
          ["leg_press_45", 3, 8, 12],
          ["hip_thrust", 2, 8, 12],
          ["cadeira_flexora_bilateral", 2, 10, 15],
          ["cadeira_extensora_unilateral", 2, 10, 15],
          ["panturrilha_leg_press", 3, 10, 15],
          ["abdutora_maquina", 2, 12, 20],
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        entries: [
          ["supino_maquina", 3, 6, 10],
          ["puxada_alta_maquina", 3, 6, 10],
          ["remada_fechada_unilateral_maquina", 2, 8, 12],
          ["agachamento_pendulo", 3, 6, 10],
          ["cadeira_flexora_unilateral", 3, 10, 15],
          ["elevacao_lateral_unilateral_polia", 3, 12, 20],
          ["face_pull", 2, 12, 20],
          ["biceps_scott_unilateral_halter", 3, 10, 15],
          ["triceps_frances_unilateral_halter", 3, 10, 15],
        ],
      },
      {
        slug: "upper", name: "Upper",
        entries: [
          ["supino_inclinado_halteres", 3, 8, 12],
          ["supino_maquina", 2, 8, 12],
          ["crucifixo_maquina", 3, 10, 15],
          ["desenvolvimento_ombros_maquina", 2, 8, 12],
          ["puxada_alta_maquina", 3, 8, 12],
          ["remada_alta_articulada_maquina", 3, 8, 12],
          ["biceps_maquina", 3, 8, 12],
          ["triceps_pushdown", 3, 8, 12],
        ],
      },
      {
        slug: "lower", name: "Lower",
        entries: [
          ["rdl_stiff", 3, 6, 10],
          ["leg_press_45", 3, 8, 12],
          ["agachamento_bulgaro", 3, 8, 12],
          ["hip_thrust", 2, 8, 12],
          ["cadeira_flexora_bilateral", 4, 10, 15],
          ["cadeira_extensora", 3, 10, 15],
          ["panturrilha_leg_press", 3, 8, 15],
          ["abdominal_maquina", 2, 10, 15],
        ],
      },
    ],
